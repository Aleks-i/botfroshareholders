...
@Component
public class CallBackWeatherKeyboardEightDay implements Keyboard {
    ...
    public ReplyKeyboard getKeyboard(long chatId) {
        ...
        coordsList.forEach(coord -> {
            ...
            if (counter.get() != 3) {
                ...
                inlinekeyboardRow[0].add(getInlineKeyboardButton(sityName, "-5-" + coord.split(" " )[0] + "-" + coord.split(" " )[1]));
            } else {
