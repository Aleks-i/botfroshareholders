...
import static ru.bot.valera.bot.model.Command.CURRENCY;
...
public class Currency extends AbstractContent implements Runnable {
    ...
    static CryptoCurrencies coinMarketCapCryptoCurrencyModel = new CryptoCurrencies();
    static FiatRub fiatToRub = new FiatRub();
    static CryptoCurrencyUSD cryptoCurrencyToUSD = new CryptoCurrencyUSD();

    static final String COINMARKETCAP_CRYPTO_CURRENCY_URL = "https://pro-api.coinmarketcap.com/v1/cryptocurrency/listings/latest?limit=5000&CMC_PRO_API_KEY=";
    static final String COINMARKETCAP_FIAT_CONVERT_RUB_URL = "https://pro-api.coinmarketcap.com/v2/cryptocurrency/quotes/latest?id=1,2781,2787,2790&convert=RUB&CMC_PRO_API_KEY=";
    static final String COINMARKETCAP_CRYPTOCURRENCY_USD_URL = "https://pro-api.coinmarketcap.com/v2/cryptocurrency/quotes/latest?id=1&CMC_PRO_API_KEY=";
